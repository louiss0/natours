      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)(alertEl, 'error', 'Error logging out! Try again.');
            setTimeout(function () {
              (0, _alerts.hideAlert)(alertEl);
            }, 500);
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var endpoint, res, alertEl;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            endpoint = type === 'password' ? 'update-my-password' : 'update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
...
var logOutBtn = document.getElementById('nav__el--logout');
