...
var CrudFactory = /** @class */ (function () {
    ...
    CrudFactory.deleteOne = function (Model) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        }, HTTPStatusCodes_1.default.NoContent);
                        return [2 /*return*/];
                }
            });
        }); });
    };
    CrudFactory.updateOne = function (Model) {
        return catchAsync_1.default(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
            var doc;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CrudFactory.createOne = function (Model) {
        return catchAsync_1.default(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
            var doc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        doc = _a.sent();
                        if (!doc) {
                            return [2 /*return*/, next(new AppError_1.default("Could not create a document", HTTPStatusCodes_1.default.NoContent))];
                        }
                        sendJson_1.default(res, {
                            status: 'success',
                        ...
                        }, HTTPStatusCodes_1.default.Created);
                        return [2 /*return*/];
                }
            });
        }); });
    };
    CrudFactory.getOne = function (Model, popOptions) {
        if (popOptions === void 0) { popOptions = null; }
        return catchAsync_1.default(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
            var query, doc;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CrudFactory.getAll = function (Model) {
        return catchAsync_1.default(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
            var filterRequest, filter, features, docs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filterRequest = __assign({}, req);
                        filter = filterRequest.filter ? filterRequest.filter : {};
